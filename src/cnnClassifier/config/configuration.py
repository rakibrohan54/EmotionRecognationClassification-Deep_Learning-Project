...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        params = self.params
        training_data = os.path.join(self.config.data_ingestion.unzip_dir, "test")
        create_directories([
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/rakibrohan54/EmotionRecognationClassification-Deep_Learning-Project.mlflow",
